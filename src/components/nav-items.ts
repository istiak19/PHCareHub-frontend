...
> = {
  ADMIN: { href: "/admin/dashboard", label: "Admin Dashboard", icon: IconHome },
  DOCTOR: { href: "/doctor/dashboard", label: "Doctor Dashboard", icon: IconHome },
  PATIENT: { href: "/patient/dashboard", label: "Patient Dashboard", icon: IconHome },
};
