...
const StepCard = ({ icon: Icon, title, description, index }: StepCardProps) => {
    return (
        <Card className="rounded-2xl shadow-card hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                    <div className={`p-3 rounded-full ${iconColors[index % 8]} bg-card text-card-foreground shadow-sm`}>
                        <Icon size={24} />
                    </div>
                    <div>
