            ...
            <div className="relative max-w-[1200px] mx-auto px-4 py-10 lg:px-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            {buttons.primary && (
                                <Button
                                    ...
                                    className="gap-3 rounded-xl bg-linear-to-r from-blue-600 to-teal-500 px-8 py-6 text-white shadow-lg shadow-blue-500/30 hover:shadow-teal-500/40 transition-all"
                                >
                            ...
                            {buttons.secondary && (
                                <Button
                                    ...
                                    variant="outline"
                                    className="gap-3 rounded-xl border-blue-500 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-8 py-6"
                                >
                    ...
                    <motion.div
                        ...
                        className="flex justify-center lg:justify-end z-10 relative"
                    >
                        <div className="w-full max-w-[500px] rounded-2xl bg-white/80 dark:bg-slate-900/70 backdrop-blur-xl border border-white/40 shadow-xl shadow-blue-200/30 dark:shadow-blue-900/30 p-8">
                            ...
                            <form className="space-y-6">
                                ...
                                <Button
                                    type="submit"
                                    className="h-12 w-full rounded-xl bg-linear-to-r from-blue-600 to-teal-500 hover:from-teal-600 hover:to-blue-600 transition-all shadow-lg shadow-blue-400/30 text-white font-medium text-base"
                                >
                                    {formCard.submitText}
                                </Button>
                            </form>
